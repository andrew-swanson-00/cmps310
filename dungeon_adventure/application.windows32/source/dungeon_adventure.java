...
public class dungeon_adventure extends PApplet {
...
public void keyPressed()
{
  ...
  case 997: 
    ...
    if ((key == 'l') || (key == 'L'))
    {
      xloc = PApplet.parseInt(savefile[0]);
      yloc = PApplet.parseInt(savefile[1]);
      levelswitch = PApplet.parseInt(savefile[2]);
      gamestate = PApplet.parseInt(savefile[3]);
    }
    break;
  case 998:
    if (key == ' ')
  ...
  if ((battlestate == 1) && (gamestate != 0))
  {
    ...
    if ((key == 'p') || (key =='P'))
    {
      String savefile0 = Integer.toString(xloc) +' ' +Integer.toString(yloc) +' ' +Integer.toString(PApplet.parseInt(levelswitch)) + ' ' +Integer.toString(gamestate);
...
public void level(String img, int typeroom, int rmleft, int rmright, int rmtop, int rmbot)
{
...
public void room(int left, int right, int top, int bot)
{
  if (xloc > 600)
  {
    gamestate = right; 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "dungeon_adventure" };
    if (passedArgs != null) {
